        ...
        <div className="  md:w-full  flex  justify-evenly items-center py-2 gap-5 ">
          ...
          <div>
            <div className=" w-[100px]  md:w-[450px] flex h-5 md:h-8">
              <input
                onChange={getData}
                className=" w-[100px] md:w-full  rounded-full outline-none  cursor-pointer p-3 border-1 border-gray-800"
                type="text"
          ...
          <div className="flex gap-2 items-center">
            ...
            <div>
              <Button className="bg-HB w-auto  text-[8px] md:text-[12px] md:font-medium rounded-full hover:bg-gray-700 text-white ">
            ...
            <li>
              <NavLink to="/">
                <div className="w-4 h-3 flex flex-col items-center">
                  <img src="all.png" alt="" />
                  <p className="text-letter font-light text-center text-[12px]">
                    All
                  </p>
                </div>
              </NavLink>
