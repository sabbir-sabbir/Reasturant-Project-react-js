        ...
        <div className="grid grid-cols-2 gap-16 ">
          {FilterOut.map((cur, i) => (
            <div key={i} className="flex border-y-1 border-letter py-2 effect">
              ...
              <div>
                <div>
                  <h1 className="text-xl font-bold  px-2 text-HB">
                    {cur.title}
                  </h1>
                </div>
                <div>
                  <p className="text-letter text-[5px] md:text-[14px] leading-tight  px-2 ">
                    {cur.body}
                  </p>
                </div>
                <div className="flex gap-1 items-center pt-2 ml-3">
                  <div>
                    <img className="w-[80px] h-[12px]" src={cur.stars} alt="" />
                  </div>
                  <div>
                    <p className="text-letter text-[6px] md:text-[14px] leading-tight py-1 px-2">
                      {cur.review}
                    </p>
                  </div>
                </div>
