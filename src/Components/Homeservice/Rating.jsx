    ...
    <section className='w-full container mx-auto h-auto border-y-1 border-letter p-6  mt-16 md:py-6'>
        <div className='flex gap-8 flex-col md:flex-row  items-center'>
            ...
            <div>
                ...
                <div><img src="overall.png" alt="" /></div>
                <div><h1 className='font-lexend text-Hb font-bold md:text-[26px] text-[10px]'>Overall rating</h1></div>
                </div>
                <div className='flex flex-col space-y-5 justify-center items-center'>
                    <div><p className='font-lexend text-letter text-[16px]'>834 Reviews</p></div>
                    <div><img className='w-25 h-5' src="5star.png" alt="" /></div>
                </div>
            </div>
            {/* second div */}
